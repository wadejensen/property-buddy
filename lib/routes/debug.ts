...
// export async function testAuth(req: express.Request, res: express.Response) {
//     let app: Express.Application = req.app
//     let flatmatesClient = <FlatmatesClient>app.flatmatesClient
//     const a = 10
//     const b = 20
//     let c = a * b
//     let str = 'hello world '
